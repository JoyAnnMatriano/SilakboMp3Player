...
controls_frame.grid(row=1, column=0, padx =0,pady=20)


# FRAME -Volume Label
volume_frame = LabelFrame(master_frame, text="Volume",fg = "white", borderwidth=3, bg = "#374045")
volume_frame.config(bg = "#374045",borderwidth=3)
volume_frame.grid(row=2, column=1, padx=10,pady = 20)

# FRAME - playlist
song_box = Listbox(master_frame, bg="#e1d89f", fg="white", width=40, selectbackground="#ffe227", selectforeground="black")
song_box.grid(row=0, column=1, pady = 10, padx = 20)
...
volume_meter.grid(row=2, column=10, padx=10)
...
back_button.grid(row=5, column=1, padx=5)
forward_button.grid(row=5, column=5, padx=5)
play_button.grid(row=5, column=3, padx=5)
pause_button.grid(row=5, column=2, padx=5)
stop_button.grid(row=5, column=4, padx=5)
