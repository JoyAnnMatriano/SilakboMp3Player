...
controls_frame.grid(row=4, column=0, padx =0,pady=0)
...
volume_frame.grid(row=4, column=1, padx=5,pady = 5, rowspan = 1)

# FRAME - playlist
song_box = Listbox(master_frame, bg="#e1d89f", fg="white", width=34, height = 14, selectbackground="#ffe227", selectforeground="black")
song_box.grid(row=1, column=1, pady = 0, padx = 20, columnspan = 20)

#FRAME- Logo
logo_frame = Frame(master_frame)
logo_frame.config(bg="#374045")
logo_frame.grid(row=1, column=2, padx =1,pady=0)

#FRAME- skins
skin_frame = Frame(master_frame)
skin_frame.config(bg="#374045")
skin_frame.grid(row=0, column=1, padx =2,pady=0)
...
my_slider.grid(row=2, column=0, pady=0)
